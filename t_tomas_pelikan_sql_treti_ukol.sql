...
LAG(prumerna_hodnota ,1) OVER (PARTITION BY code ORDER BY rok) AS prumerna_hodnota_B, concat('Kč/unit') AS hodnota_B 
...
SELECT *,
round(((prumerna_hodnota - prumerna_hodnota_B) / prumerna_hodnota_B  ) * 100, 1) AS percentualni_mezirocni_narust
