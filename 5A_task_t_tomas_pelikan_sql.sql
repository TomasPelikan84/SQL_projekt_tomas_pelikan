...
JOIN tp_mezirocni_rozdil_GDP b
	ON base.rok = b.nasledujici_rok  
JOIN tp_percentulni_rust_mzdy c
	ON base.rok = c.nasledujici_rok  ;
...
SELECT*,
round ((prumerna_hodnota - prumerna_hodnota_predchozi_rok) / prumerna_hodnota_predchozi_rok  * 100, 1) AS percent_rust_potravin
