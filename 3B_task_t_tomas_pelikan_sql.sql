...
SELECT
base.kategorie_potravin, base.rok AS rok_A,base.suma_potravin AS suma_potravin,concat('Kč/unit') AS hodnota,  
a.rok AS nasledujici_rok ,a.suma_potravin AS suma_potravin_nasledujici_rok  ,  concat('Kč/unit') AS hodnota_B,
